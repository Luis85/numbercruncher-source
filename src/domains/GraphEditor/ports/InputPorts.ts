...
export const BASIC_NODE_INPUTS = {
  ...
  x: () => new NumberInterface('X', 0).setHidden(true).use(displayInSidebar, true).setPort(false),
  y: () => new NumberInterface('Y', 0).setHidden(true).use(displayInSidebar, true).setPort(false),
  z: () => new NumberInterface('Z', 0).setHidden(true).use(displayInSidebar, true).setPort(false),
  schema: () =>
